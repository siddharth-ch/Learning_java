public class NQueen {
	 ...
	 * returns FALSE. x[] is a global array whose first (r-1) values have been set.
	 */
	for (int i = 0; i < r; i++) {
	...
	/**
	 * Using backtracking this method prints all possible placements of n queens on
	 * an n x n chessboard so that they are non-attacking.
	 */
	for (int c = 0; c < n; c++) {
