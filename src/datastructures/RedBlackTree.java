...
public class RedBlackTree<Key extends Comparable<Key>, Value> {
	...
	public String toString() {
	    ...
	    return this == null ? null : key.toString();
	}
    }
	...
	if (isRed(h.right) && !isRed(h.left)) {
	    System.out.println("Red right Black Left : " + h.key + " : Left: " + h.left + " Right: " + h.right);
	    h = rotateLeft(h);
	    System.out.println("After rotation : " + h.key + "(" + h.color + ")" + " : Left: " + h.left + "(" + h.color
		    + ") " + " Right: " + h.right + "(" + h.color + ")");
	}
	if (isRed(h.left) && isRed(h.left.left)) {
	    System.out.println("RedLeft && RED left.left : " + h.key + " : Left: " + h.left + " Right: " + h.left.left);
	    h = rotateRight(h);
	    System.out.println("After rotation : " + h.key + "(" + h.color + ")" + " : Left: " + h.left + "(" + h.color
		    + ") " + " Right: " + h.right + "(" + h.color + ")");
	}
	if (isRed(h.left) && isRed(h.right)) {
	    System.out.println("RedLeft && RED right : " + h.key + " : Left: " + h.left + " Right: " + h.right);
	    flipColors(h);
	    System.out.println("After rotation : " + h.key + "(" + h.color + ")" + " : Left: " + h.left + "(" + h.color
		    + ") " + " Right: " + h.right + "(" + h.color + ")");
	}
	...
	RedBlackTree<Integer, Object> st = new RedBlackTree<>();
	// for (int i = 0; !System.in.isEmpty(); i++) {
	// String key = System.in.readString();N
	Object o = new Object();
	st.put(10, o);
	st.put(20, o);
	st.put(-10, o);
